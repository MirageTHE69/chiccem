...
function Topnavbar(){
    return(
        <nav className="flex flex-col sm:flex-row justify-between py-5 sm:py-5   px-20 w-screen items-center sm:items-center h-[5%] sm:h-auto bg-[#2AA7FF] text-white ">
        <div className='font-Jost text-xs sm:text-sm  font-medium text-center'>
